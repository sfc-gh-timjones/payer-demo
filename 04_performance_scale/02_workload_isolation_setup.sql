...
--
-- Two cost centers map the 4 workload teams into CalOptima departments:
...
-- =============================================================================
-- PART 2: ISOLATION PROOF (run after all 4 tabs have finished)
-- =============================================================================
...
ORDER BY compute_credits DESC;
-- Expected:
--   ANALYTICS  → highest  (ANALYST_WH + ML_WH combined, Medium WH, heavier queries)
--   OPERATIONS → lower    (EXEC_WH XSmall + FINANCE_WH Small, lighter queries)
