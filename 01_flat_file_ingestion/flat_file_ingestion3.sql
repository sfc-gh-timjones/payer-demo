...
/***********************************************************************
DEMO: Ingesting data into Snowflake via Internal Stage (backup option).
...
CREATE SCHEMA IF NOT EXISTS INGEST_DEMO.INTERNAL;
...
--   SnowSQL:   PUT file://path/to/pharmacy_claims.csv @MY_STAGE;
--              PUT file://path/to/pharmacy_claims_bad_records.csv @MY_STAGE;
--              PUT file://path/to/medical_claims.xml @MY_STAGE;
--              PUT file://path/to/pharmacy_claims_add_refillnum.csv @MY_STAGE;
--              PUT file://path/to/pharmacy_claims_inc1.csv @MY_STAGE;
--              PUT file://path/to/pharmacy_claims_inc2.csv @MY_STAGE;
