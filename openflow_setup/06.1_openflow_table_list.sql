...
--          Lowercase identifiers (openflow, raw) must be quoted per the UI tooltip.
--          Uppercase table names (CMC_*) do not require quotes.
--
...
-- ── SINGLE-LINE (safe to paste directly into Openflow) ────────────────────────
/*
